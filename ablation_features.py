"""Connect CWM's 13 feature fields to test whether user-side features help FM."""
...
def build(mode):
    """mode: 'base'=5 fields (current kit) / 'item'=item-side additions only / 'cwm13'=all 13 CWM fields"""
