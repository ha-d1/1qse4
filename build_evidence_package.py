...
- `checkpoint_manifest.json`: SHA-256 checksums and metadata for the five accepted models.
- `checkpoints/`: the actual five accepted four-negative BPR FM checkpoints.
